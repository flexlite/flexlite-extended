package org.flexlite.domUI.skins
{
	...
	public class IncrementButtonSkin extends VectorSkin
	{
		public function IncrementButtonSkin()
		{
			super();
		...
		override protected function updateDisplayList(w:Number, h:Number):void
		{
			...
			g.clear();
			var arrowColor:uint;
			var radius:Object = {tl:0,tr:cornerRadius,bl:0,br:0};
			switch (currentState)
			{			
				case "up":
				case "disabled":
			...
			*/
			g.moveTo(w*0.5,h*0.5 - 2 );
			g.lineTo(w*0.5 -3.5,h*0.5 + 3 );
			g.lineTo(w*0.5+3.5,h*0.5+3);
			g.lineTo(w*0.5,h*0.5 - 2 );
